      ...
      <Layout>
        <Content className="containerStyle">
          <div className="innerDiv">
            ...
            <Col span={24}>
              <Title className="headText" level={1}>
                The Green Logistics <br /> Summit & Awards
              </Title>
            </Col>
            ...
            <Col>
              <Title className="subtitleText" level={2}>
                20 September 2023 <br /> | Virtual event |
              </Title>
            </Col>

            <Col>
              <Button className="registerBtn">
                <Link href="http://thegreenlogisticssummitandaward.co/">
                  Register now
                </Link>
              </Button>
            </Col>
